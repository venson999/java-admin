...
class GlobalExceptionHandlerTest extends AbstractUnitTest {
    ...
    void shouldHandleDifferentAuthenticationExceptions() {
        ...
        // Then
        assertThat(response1.getStatusCodeValue()).isEqualTo(401);
        assertThat(response1.getBody().getCode()).isEqualTo("30000");
        assertThat(response2.getStatusCodeValue()).isEqualTo(401);
    ...
    void shouldHandleDifferentSystemExceptions() {
        ...
        // Then
        assertThat(response1.getStatusCodeValue()).isEqualTo(500);
        assertThat(response2.getStatusCodeValue()).isEqualTo(500);
        assertThat(response3.getStatusCodeValue()).isEqualTo(500);
    ...
    void shouldHandleNullExceptionMessage() {
        // Given
        AuthenticationException exception = new BadCredentialsException((String) null);
    ...
    void shouldHandleMultipleDifferentExceptions() {
        ...
        // Then
        assertThat(response1.getStatusCodeValue()).isEqualTo(401);
        assertThat(response2.getStatusCodeValue()).isEqualTo(403);
        assertThat(response3.getStatusCodeValue()).isEqualTo(400);
    }
}
