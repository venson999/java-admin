 ...
 * <ul>
 *   <li>AbstractUnitTest - Test base class</li>
...
class TestInfrastructureExample extends AbstractUnitTest {

    @Test
    @DisplayName("Should create default user using TestDataFactory")
    void shouldCreateDefaultUserUsingTestDataFactory() {
    ...
    void shouldCreateUserWithCustomUsername() {
    ...
    void shouldCreateLoginUser() {
        ...
        assertThat(loginUser.getUsername()).isEqualTo("testuser");
